...
let room_lights = [false, false, false, false]; // Default state of the lights

// Pull the state of the lights from localStorage if it exists, otherwise initialize it
...
// Pull the AC temperature from localStorage if it exists, otherwise initialize it
